...
call s:Init_option("g:psc_style","'cool'")
call s:Init_option("g:psc_fontface","'plain'")
call s:Init_option("g:psc_inversed_todo",0)
call s:Init_option("g:psc_use_default_for_cterm",0)
call s:Init_option("g:psc_statement_different_from_type",0)

if exists("statement_different_from_type") " This is for backward compatibility
  call s:Init_option("g:psc_statement_different_from_type",1)
else 
  call s:Init_option("g:psc_statement_different_from_type",0)
endif
...
command! -nargs=1 Colo if 'ps_color'!='<args>' | 
	\let psc_style='<args>'| endif | colo ps_color
...
if psc_fontface=="plain"
  ...
  call s:Hi("gui=NONE", "ModeMsg", "Search", "Visual", "Cursor", "Special", 
	\"Comment", "Constant", "Number", "StatusLine", "LineNr", 
	\"Question", "PreProc", "Statement", "Type", "Todo", "Error", 
	\"Identifier", "Normal")

  call s:Hi("gui=NONE", "VisualNOS", "SpecialKey", "NonText", "Directory", 
	\"ErrorMsg", "MoreMsg", "Title", "WarningMsg", "WildMenu", "Folded",
	\"FoldColumn", "DiffAdd", "DiffChange", "DiffDelete", "DiffText", 
	\"SignColumn", "IncSearch", "StatusLineNC", "VertSplit")
endif
...
if !has('gui_running')
  ...
  if psc_style=='cool'
    ...
    if &t_Co==8
      ...
      " supports 16 colours, 
      call s:Hi("cterm=none", "DiffText", "Visual", "Cursor", "Comment", "Todo",
	\"StatusLine", "Question", "DiffChange", "ModeMsg", "VisualNOS",
	\"ErrorMsg", "WildMenu", "DiffAdd", "Folded", "DiffDelete", "Normal")
      call s:Hi("cterm=bold", "Search", "Special", "Constant", "Number",
	\"LineNr", "PreProc", "Statement", "Type", "Error", "Identifier", 
	\"SpecialKey", "NonText", "MoreMsg", "Title", "WarningMsg", 
	\"FoldColumn", "SignColumn", "Directory", "DiffDelete")
      ...
      call s:Hi("cterm=none", "WarningMsg", "Search", "Visual", "Cursor",
	\"Special", "Comment", "Constant", "Number", "LineNr", "PreProc", 
	\"Todo", "Error", "Identifier", "Folded", "SpecialKey", "Directory",
	\"ErrorMsg", "Normal")
      call s:Hi("cterm=none", "WildMenu", "FoldColumn", "SignColumn",
	\"DiffAdd", "DiffChange", "Question", "StatusLine", "DiffText")
      call s:Hi("cterm=reverse", "IncSearch", "StatusLineNC", "VertSplit")

      " Well, well, bold font with color 0-7 is not possible.
      " So, the Question, StatusLine, DiffText cannot act as expected.

      call s:Hi("cterm=".((psc_fontface=="plain") ? "none" : "bold"), 
	\"Statement", "Type", "MoreMsg", "ModeMsg", "NonText", "Title", 
	\"VisualNOS", "DiffDelete")
